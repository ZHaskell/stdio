...
word8_100000000 =
    ...
    , bench "stdio/buildBytesList"     $ nf B.buildBytesList (mconcat (replicate 100000000 (B.encodePrim @Word8 123)))
    , bench "stdio/buildBytes"     $ nf B.buildBytes (mconcat (replicate 100000000 (B.encodePrim @Word8 123)))
    , bench "stdio/buildAndRun"     $ nfIO (B.buildAndRun (void . evaluate) (mconcat (replicate 100000000 (B.encodePrim @Word8 123))))
    ]
...
word8_10000 =
    ...
    , bench "stdio/buildBytesList"     $ nf B.buildBytesList (mconcat (replicate 10000 (B.encodePrim @Word8 123)))
    , bench "stdio/buildBytes"     $ nf B.buildBytes (mconcat (replicate 10000 (B.encodePrim @Word8 123)))
    , bench "stdio/buildAndRun"     $ nfIO (B.buildAndRun (void . evaluate) (mconcat (replicate 10000 (B.encodePrim @Word8 123))))
    ]
...
word8_32 =
    ...
    , bench "stdio/buildBytesList"     $ nf B.buildBytesList (mconcat (replicate 32 (B.encodePrim @Word8 123)))
    , bench "stdio/buildBytes"     $ nf B.buildBytes (mconcat (replicate 32 (B.encodePrim @Word8 123)))
    , bench "stdio/buildAndRun"     $ nfIO (B.buildAndRun (void . evaluate) (mconcat (replicate 32 (B.encodePrim @Word8 123))))
    ]
...
bytes_32_1000 =
    ...
    , bench "stdio/buildBytesList"     $ nf B.buildBytesList (mconcat (replicate 32 (B.bytes bytes1000)))
    , bench "stdio/buildAndRun"     $ nfIO (B.buildAndRun (void . evaluate) (mconcat (replicate 32 (B.bytes bytes1000))))
    ]
...
bytes_32_20000 =
    ...
    , bench "stdio/buildBytesList"     $ nf B.buildBytesList (mconcat (replicate 32 (B.bytes bytes20000)))
    , bench "stdio/buildAndRun"     $ nfIO (B.buildAndRun (void . evaluate) (mconcat (replicate 32 (B.bytes bytes20000))))
    ]
